<template>
    <div class="view">
        <div class="header">
            ...
            <div class="empty" @click="onSubmit">저장</div>
        </div>
        <div class="contents">
            <div class="cont">
            ...
            <div class="cont">
                <span class="small-title"><v-icon name="image"></v-icon>사진 업로드</span>
                <!-- <div class="pic">
            ...
            <div class="cont">
                ...
                <textarea v-model="item.itemMemo" placeholder="메모를 적어주세요"></textarea>
            </div>
            <div class="btn-area">
